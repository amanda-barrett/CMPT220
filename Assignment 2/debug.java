...
public class debug {
    public static void main(String[] args) {
        ...
        // add else if for if variable is 4
        int var1 = 4;
        if (var1 > 4){
        ...
        // change else statement to invalid input; if comparing just to 5, all options (=,<,>) were accounted for
        int var2 = 6;
        if (var2 == 5){
        ...
        // added else if option for if var3=10
        int var3 = 5;
        if (var3 > 10){
        ...
        // imported scanner, set scanner, asked question, set input variable
